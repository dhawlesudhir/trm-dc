...
<!--    Favicons-->
<!-- ===============================================-->
<link rel="apple-touch-icon" sizes="180x180" href="{{ Vite::asset('resources/resources/assets/img/favicons/apple-touch-icon.png') }}">
<link rel="icon" type="image/png" sizes="32x32" href="{{ Vite::asset('resources/assets/img/favicons/favicon-32x32.png')}}">
<link rel="icon" type="image/png" sizes="16x16" href="{{ Vite::asset('resources/assets/img/favicons/favicon-16x16.png')}}">
<link rel="shortcut icon" type="image/x-icon" href="{{ Vite::asset('resources/assets/img/favicons/favicon.ico')}}">
<link rel="manifest" href="{{ Vite::asset('resources/assets/img/favicons/manifest.json')}}">
<meta name="msapplication-TileImage" content="{{ Vite::asset('resources/assets/img/favicons/mstile-150x150.png')}}">
...
<link href="{{ Vite::asset("resources/assets/css/theme.css")}}" type="text/css" rel="stylesheet" id="style-default">
